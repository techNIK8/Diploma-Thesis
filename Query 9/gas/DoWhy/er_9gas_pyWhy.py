...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_9gas.csv')
...
floor_area_per_room_mean -> radiators;
floor_area_per_room_mean -> dehumidifier_electric;
floor_area_per_room_mean -> electricheater_electric;
floor_area_per_room_mean -> gasfire_gas;
floor_area_per_room_mean -> woodburningstove_other_fuel;
floor_area_per_room_mean -> air_conditioning;
floor_area_per_room_mean -> dehumidifier;
floor_area_per_room_mean -> electric_blanket;
floor_area_per_room_mean -> electric_fan;
floor_area_per_room_mean -> electric_heater;
floor_area_per_room_mean -> humidifier;
floor_area_per_room_mean -> vacuum_cleaner;
build_era -> floor_area_per_room_mean;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_9gas_hot_months.json', 'w') as fp:
