...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_4el.csv')
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_4el_hot_months.json', 'w') as fp:
