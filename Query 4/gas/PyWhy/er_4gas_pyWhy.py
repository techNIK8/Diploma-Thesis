...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_4gas.csv')
...
many_openablewindows -> radiators;
many_openablewindows -> dehumidifier_electric;
many_openablewindows -> electricheater_electric;
many_openablewindows -> gasfire_gas;
many_openablewindows -> woodburningstove_other_fuel;
many_openablewindows -> air_conditioning;
many_openablewindows -> dehumidifier;
many_openablewindows -> electric_blanket;
many_openablewindows -> electric_fan;
many_openablewindows -> electric_heater;
many_openablewindows -> humidifier;
...
build_era -> many_openablewindows;
...
model= CausalModel(
        ...
        treatment='many_openablewindows',
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_4gas_hot_months.json', 'w') as fp:
