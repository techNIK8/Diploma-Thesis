...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_11el.csv')
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_11el_full_year.json', 'w') as fp:
