...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_11gas.csv')
...
high_cubic_area_with_trvs_percent;
dehumidifier;
dishwasher_electric;
...
radiators -> high_cubic_area_with_trvs_percent;
...
high_cubic_area_with_trvs_percent -> dehumidifier_electric;
high_cubic_area_with_trvs_percent -> electricheater_electric;
high_cubic_area_with_trvs_percent -> gasfire_gas;
high_cubic_area_with_trvs_percent -> woodburningstove_other_fuel;
high_cubic_area_with_trvs_percent -> air_conditioning;
high_cubic_area_with_trvs_percent -> dehumidifier;
high_cubic_area_with_trvs_percent -> electric_blanket;
high_cubic_area_with_trvs_percent -> electric_fan;
high_cubic_area_with_trvs_percent -> electric_heater;
high_cubic_area_with_trvs_percent -> humidifier;
...
build_era -> high_cubic_area_with_trvs_percent;
...
model= CausalModel(
        ...
        treatment='high_cubic_area_with_trvs_percent',
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_1el_full_year.json', 'w') as fp:
