...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_11gas.csv')

treatment = df['high_cubic_area_with_trvs_percent']
y = df['high_gas_pulse_consumption']
df.drop('high_cubic_area_with_trvs_percent', axis=1, inplace=True)
...
treat_col_name = 'high_cubic_area_with_trvs_percent'
