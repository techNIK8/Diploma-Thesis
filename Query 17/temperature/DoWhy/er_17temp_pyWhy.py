...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_17temp.csv')
...
income_band -> many_air_conditioning_fans;
...
residents -> many_air_conditioning_fans;
...
many_air_conditioning_fans -> high_electric_consumption;
many_air_conditioning_fans -> gas_pulse_per_year_mean;
...
externalwindows -> many_air_conditioning_fans;
...
windowsopen -> many_air_conditioning_fans;
...
externaldoors -> many_air_conditioning_fans;
...
externalwalls -> many_air_conditioning_fans;
...
cubic_area -> many_air_conditioning_fans;
...
cubic_area_for_clothesdrying_percent -> many_air_conditioning_fans;
...
cubic_area_with_trvs_percent -> many_air_conditioning_fans;
...
radiators -> low_temperature;
cubic_area_with_trvs_percent -> low_temperature;
electric_heater -> low_temperature;
electricheater_electric -> low_temperature;
woodburningstove_other_fuel -> low_temperature;
many_air_conditioning_fans -> low_temperature;
gasfire_gas -> low_temperature; 
...
model= CausalModel(
        ...
        treatment='many_air_conditioning_fans',
        outcome='low_temperature')
model.view_model()
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_17temp_hot_months.json', 'w') as fp:
