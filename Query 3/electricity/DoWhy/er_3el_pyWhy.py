...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_3el.csv')
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_3el_hot_months.json', 'w') as fp:
