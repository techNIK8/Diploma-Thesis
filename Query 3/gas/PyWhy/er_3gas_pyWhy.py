...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_3gas.csv')
...
many_externalwindows -> radiators;
many_externalwindows -> dehumidifier_electric;
many_externalwindows -> electricheater_electric;
many_externalwindows -> gasfire_gas;
many_externalwindows -> woodburningstove_other_fuel;
many_externalwindows -> air_conditioning;
many_externalwindows -> dehumidifier;
many_externalwindows -> electric_blanket;
many_externalwindows -> electric_fan;
many_externalwindows -> electric_heater;
many_externalwindows -> humidifier;
...
build_era -> many_externalwindows;
...
model= CausalModel(
        ...
        treatment='many_externalwindows',
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_3gas_hot_months.json', 'w') as fp:
