...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_3gas.csv')

treatment = df['many_externalwindows']
y = df['high_gas_pulse_consumption']
df.drop('many_externalwindows', axis=1, inplace=True)
...
treat_col_name = 'many_externalwindows'
