...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_8gas.csv')
...
externaldoors;
externalwalls;
high_floor_area_per_room;
height_per_room_mean;
radiators;
...
height_per_room_mean -> radiators;
height_per_room_mean -> dehumidifier_electric;
height_per_room_mean -> electricheater_electric;
height_per_room_mean -> gasfire_gas;
height_per_room_mean -> woodburningstove_other_fuel;
height_per_room_mean -> air_conditioning;
height_per_room_mean -> dehumidifier;
height_per_room_mean -> electric_blanket;
height_per_room_mean -> electric_fan;
height_per_room_mean -> electric_heater;
height_per_room_mean -> humidifier;
height_per_room_mean -> vacuum_cleaner;
build_era -> height_per_room_mean;
high_floor_area_per_room -> radiators;
high_floor_area_per_room -> dehumidifier_electric;
high_floor_area_per_room -> electricheater_electric;
high_floor_area_per_room -> gasfire_gas;
high_floor_area_per_room -> woodburningstove_other_fuel;
high_floor_area_per_room -> air_conditioning;
high_floor_area_per_room -> dehumidifier;
high_floor_area_per_room -> electric_blanket;
high_floor_area_per_room -> electric_fan;
high_floor_area_per_room -> electric_heater;
high_floor_area_per_room -> humidifier;
high_floor_area_per_room -> vacuum_cleaner;
build_era -> high_floor_area_per_room;
...
model= CausalModel(
        ...
        treatment='high_floor_area_per_room',
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_8gas_hot_months.json', 'w') as fp:
