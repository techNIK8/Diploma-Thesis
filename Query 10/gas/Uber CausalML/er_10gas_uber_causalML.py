...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_10gas.csv')

treatment = df['high_cubic_area_for_clothesdrying_percent']
y = df['high_gas_pulse_consumption']
df.drop('high_cubic_area_for_clothesdrying_percent', axis=1, inplace=True)
df.drop('high_gas_pulse_consumption', axis=1, inplace=True)
X = df
...
treat_col_name = 'high_cubic_area_for_clothesdrying_percent'
outcome_col_name = 'high_gas_pulse_consumption'
