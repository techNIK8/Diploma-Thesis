...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_10gas.csv')
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_10gas_full_year.json', 'w') as fp:
