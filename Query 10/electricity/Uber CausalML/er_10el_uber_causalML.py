...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_10el.csv')

treatment = df['high_cubic_area_for_clothesdrying_percent']
y = df['high_electric_consumption']
df.drop('high_cubic_area_for_clothesdrying_percent', axis=1, inplace=True)
df.drop('high_electric_consumption', axis=1, inplace=True)
X = df
...
outcome_col_name = 'high_electric_consumption'
