...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_10el.csv')
...
cubic_area;
radiators;
high_cubic_area_for_clothesdrying_percent;
...
high_cubic_area_for_clothesdrying_percent -> dehumidifier;
high_cubic_area_for_clothesdrying_percent -> dehumidifier_electric;
...
high_cubic_area_for_clothesdrying_percent -> radiators;
high_cubic_area_for_clothesdrying_percent -> dehumidifier_electric;
high_cubic_area_for_clothesdrying_percent -> electricheater_electric;
high_cubic_area_for_clothesdrying_percent -> gasfire_gas;
high_cubic_area_for_clothesdrying_percent -> woodburningstove_other_fuel;
high_cubic_area_for_clothesdrying_percent -> air_conditioning;
high_cubic_area_for_clothesdrying_percent -> electric_blanket;
high_cubic_area_for_clothesdrying_percent -> electric_fan;
high_cubic_area_for_clothesdrying_percent -> electric_heater;
high_cubic_area_for_clothesdrying_percent -> humidifier;
...
build_era -> high_cubic_area_for_clothesdrying_percent;
...
urban_rural_name_Large_Urban_Areas -> high_cubic_area_for_clothesdrying_percent;
...
urban_rural_name_Other_Urban_Areas -> high_cubic_area_for_clothesdrying_percent;
...
urban_rural_name_Small_Towns_or_Rural_Areas -> high_cubic_area_for_clothesdrying_percent;
...
model= CausalModel(
        ...
        treatment='high_cubic_area_for_clothesdrying_percent',
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_10el_full_year.json', 'w', encoding='utf-8') as fp:
