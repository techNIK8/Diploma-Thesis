...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_14el.csv')
...
many_electric_heaters -> high_electric_consumption;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_14el_cold_months.json', 'w') as fp:
