...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_14gas.csv')
...
many_electric_heaters -> electric_con_per_year_mean;
many_electric_heaters -> high_gas_pulse_consumption;
many_electric_heaters -> high_gas_pulse_consumption;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_14gas_cold_months.json', 'w') as fp:
