...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_1gas.csv')
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_1gas_hot_months.json', 'w') as fp:
