...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_1el.csv')
...
high_income -> residents;
high_income -> electric_fan;
high_income -> sound_system;
high_income -> iron;
high_income -> media_entertainment;
high_income -> laptop;
high_income -> smartphone;
high_income -> television;
high_income -> computer;
high_income -> tablet;
high_income -> non_smart_phone;
high_income -> motor_vehicle;
high_income -> dishwasher_electric; 
high_income -> electrichob_electric;
high_income -> electricoven_electric;
high_income -> other_electric;
high_income -> vacuumcleaner_electric;
high_income -> freezer_electric;
high_income -> grill_electric;
high_income -> tumbledrier_electric;
high_income -> washingmachine_electric;
high_income -> washigmachinetumbledrier;
high_income -> fridge_electric;
high_income -> electricheater_electric;
high_income -> kettle_electric;
high_income -> microwave_electric;
high_income -> air_conditioning;
high_income -> dehumidifier;
high_income -> dehumidifier_electric;
high_income -> electric_blanket;
high_income -> electric_heater;
high_income -> build_era;
high_income -> vacuum_cleaner;
high_income -> outdoor_electric_space_heater;
high_income -> humidifier;
high_income -> other_high_power_1;
high_income -> other_high_power_2;
high_income -> other_high_power_3;
high_income -> other_high_power_4;
high_income -> gashob_gas;
high_income -> gasoven_gas;
high_income -> toaster_electric;
...
ageleavingeducation -> high_income;
...
education_A_to_Levels_or_Highers -> high_income;
education_Degree_level_qualification_or_equivalent_eg_BSc_BA_MSc_MA -> ageleavingeducation;
education_Degree_level_qualification_or_equivalent_eg_BSc_BA_MSc_MA -> high_income;
education_GCSE_grade_D_to_G_or_CSE_grade_2_to_5_or_Standard_Grade_level_4_to_6 -> ageleavingeducation;
education_GCSE_grade_D_to_G_or_CSE_grade_2_to_5_or_Standard_Grade_level_4_to_6 -> high_income;
education_Higher_educational_qualification_below_degree_level -> ageleavingeducation;
education_Higher_educational_qualification_below_degree_level -> high_income;
education_No_formal_qualifications -> ageleavingeducation;
education_No_formal_qualifications -> high_income;
...
education_O_Level_or_GCSE_equivalent_Grade_A_to_C_or_O_Grade_CSE_equivalent_Grade_1_or_Standard_Grade_level_1 -> high_income;
education_Other_qualifications -> ageleavingeducation;
education_Other_qualifications -> high_income;
education_PhD -> ageleavingeducation;
education_PhD -> high_income;
...
#       for key_1, data in results.items()
#           for key_2, data in data.items()}        

with open(r'C:\Users\User\Desktop\Results doWhy\result_er_1el_hot_months.json', 'w', encoding='utf-8') as fp:
