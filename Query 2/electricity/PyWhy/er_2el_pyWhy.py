...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_2el.csv')
...
high_level_education -> ageleavingeducation;
high_level_education -> high_income;
...
model= CausalModel(
        ...
        treatment='high_level_education',
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_2el_hot_months.json', 'w') as fp:
