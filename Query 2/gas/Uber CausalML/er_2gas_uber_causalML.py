...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_2gas.csv')
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_2gas.csv')

treatment = df['high_level_education']
y = df['high_gas_pulse_consumption']
df.drop('high_level_education', axis=1, inplace=True)
...
treat_col_name = 'high_level_education'
