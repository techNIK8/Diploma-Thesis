...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_5el.csv')
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_5el.csv')

treatment = df['many_externaldoors']
y = df['high_electric_consumption']
df.drop('many_externaldoors', axis=1, inplace=True)
...
treat_col_name = 'many_externaldoors'
