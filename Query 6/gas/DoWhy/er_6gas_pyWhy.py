...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_6gas.csv')
...
many_externalwalls -> radiators;
many_externalwalls -> dehumidifier_electric;
many_externalwalls -> electricheater_electric;
many_externalwalls -> gasfire_gas;
many_externalwalls -> woodburningstove_other_fuel;
many_externalwalls -> air_conditioning;
many_externalwalls -> dehumidifier;
many_externalwalls -> electric_blanket;
many_externalwalls -> electric_fan;
many_externalwalls -> electric_heater;
many_externalwalls -> humidifier;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_6gas_hot_months.json', 'w') as fp:
