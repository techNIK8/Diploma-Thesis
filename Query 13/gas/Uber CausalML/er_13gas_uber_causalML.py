...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_13gas.csv')

treatment = df['urban_area']
y = df['high_gas_pulse_consumption']
df.drop('urban_area', axis=1, inplace=True)
