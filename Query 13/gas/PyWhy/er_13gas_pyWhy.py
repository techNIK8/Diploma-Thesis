...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_13gas.csv')
...
urban_area -> outdoor_water_feature;
urban_area -> outdoor_electric_space_heater;
urban_area -> outdoor_hot_tub;
urban_area -> outdoor_light;
urban_area -> woodburningstove_other_fuel;
urban_area -> cubic_area_with_trvs_percent;
urban_area -> externalwalls;
urban_area -> cubic_area_for_clothesdrying_percent;
urban_area -> windowsopen;
urban_area -> cubic_area;
urban_area -> radiators;
urban_area -> externalwindows;
urban_area -> build_era;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_13gas_hot_months.json', 'w') as fp:
