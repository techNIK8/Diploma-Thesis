...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_18gas.csv')
...
dehumidifier -> electric_con_mean;
dehumidifier -> high_gas_pulse_consumption;
dishwasher_electric -> electric_con_mean;
electricheater_electric -> electric_con_mean;
electrichob_electric -> electric_con_mean;
electrichob_electric -> electricoven_electric;
electrichob_electric -> gashob_gas;
electricoven_electric -> electric_con_mean;
electricoven_electric -> gasoven_gas;
electricshower_electric -> electric_con_mean;
...
fridgefreezer_electric -> electric_con_mean;
grill_electric -> electric_con_mean;
kettle_electric -> electric_con_mean;
microwave_electric -> electric_con_mean;
other_electric -> electric_con_mean;
toaster_electric -> electric_con_mean;
tumbledrier_electric -> washingmachinetumbledrier_electric;
vacuumcleaner_electric -> electric_con_mean;
washingmachine_electric -> washingmachinetumbledrier_electric;
washingmachinetumbledrier_electric -> electric_con_mean;
woodburningstove_other_fuel -> electric_con_mean;
woodburningstove_other_fuel -> high_gas_pulse_consumption;
air_conditioning -> electric_fan;
air_conditioning -> electric_con_mean;
air_conditioning -> high_gas_pulse_consumption;
computer -> electric_con_mean;
dehumidifier_electric -> electric_con_mean;
dehumidifier_electric -> high_gas_pulse_consumption;
electric_blanket -> electric_con_mean;
electric_blanket -> high_gas_pulse_consumption;
electric_fan -> electric_con_mean;
electric_fan -> high_gas_pulse_consumption;
electric_heater -> electric_con_mean;
electric_heater -> high_gas_pulse_consumption;
electric_heater -> high_gas_pulse_consumption;
humidifier -> electric_con_mean;
humidifier -> high_gas_pulse_consumption;
iron -> electric_con_mean;
laptop -> electric_con_mean;
media_entertainment -> electric_con_mean;
motor_vehicle -> electric_con_mean;
non_smartphone -> electric_con_mean;
other_high_power_1 -> electric_con_mean;
other_high_power_2 -> electric_con_mean;
other_high_power_3 -> electric_con_mean;
other_high_power_4 -> electric_con_mean;
outdoor_electric_space_heater -> electric_con_mean;
outdoor_hot_tub -> electric_con_mean;
outdoor_light -> electric_con_mean;
outdoor_water_feature -> electric_con_mean;
smartphone -> media_entertainment;
smartphone -> non_smartphone;
smartphone -> electric_con_mean;
sound_system -> electric_con_mean;
tablet -> media_entertainment;
tablet -> electric_con_mean;
television -> media_entertainment;
vacuum_cleaner -> electric_con_mean;
unit_charge_pence_per_kwh_electricity -> electric_con_mean;
unit_charge_pence_per_kwh_gas -> electric_con_mean;
unit_charge_pence_per_kwh_electricity -> high_gas_pulse_consumption;
bath_gas -> high_gas_pulse_consumption;
bath_gas -> electric_con_mean;
shower_gas -> electric_con_mean;
shower_gas -> high_gas_pulse_consumption;
gasfire_gas -> high_gas_pulse_consumption;
gasfire_gas -> electric_con_mean;
gashob_gas -> high_gas_pulse_consumption;
gashob_gas -> electric_con_mean;
gasoven_gas -> high_gas_pulse_consumption;
gasoven_gas -> electric_con_mean;
...
gasfire_gas -> light_mean
winter_time -> electric_con_mean;
winter_time -> light_mean;
winter_time -> high_gas_pulse_consumption;
residents -> light_mean;
externalwindows -> light_mean;
light_mean -> electric_con_mean;
gasfire_gas -> winter_time;
light_mean -> high_gas_pulse_consumption;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_18gas_winter_time-summer_time.json', 'w') as fp:
