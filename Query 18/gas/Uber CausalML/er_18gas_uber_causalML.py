...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_18gas.csv')

treatment = df['winter_time']
y = df['high_gas_pulse_consumption']
df.drop('winter_time', axis=1, inplace=True)
