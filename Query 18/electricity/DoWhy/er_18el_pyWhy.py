...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_18el.csv')
...
electricshower_electric -> gas_pulse_mean;
...
unit_charge_pence_per_kwh_electricity -> gas_pulse_mean;
bath_gas -> gas_pulse_mean;
bath_gas -> high_electric_consumption;
shower_gas -> high_electric_consumption;
shower_gas -> gas_pulse_mean;
gasfire_gas -> gas_pulse_mean;
gasfire_gas -> high_electric_consumption;
gashob_gas -> gas_pulse_mean;
gashob_gas -> high_electric_consumption;
gasoven_gas -> gas_pulse_mean;
...
winter_time -> high_electric_consumption;
winter_time -> light_mean;
winter_time -> gas_pulse_mean;
residents -> light_mean;
externalwindows -> light_mean;
light_mean -> high_electric_consumption;
light_mean -> gas_pulse_mean;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_18el_winter_time-summer_time.json', 'w') as fp:
