...
income_band;
gas_pulse_per_cold_months_mean;
electric_con_per_cold_months_mean;
bath_gas;
gasfire_gas;
gashob_gas;
gasoven_gas;
...
education_PhD;
urban_urban_rural_name_Large_Urban_Areas;
...
income_band -> many_electric_heaters;
...
residents -> many_electric_heaters;
...
radiators -> many_electric_heaters;
radiators -> electric_con_per_cold_months_mean;
radiators -> gas_pulse_per_cold_months_mean;
...
dehumidifier -> electric_con_per_cold_months_mean;
dehumidifier -> gas_pulse_per_cold_months_mean;
dishwasher_electric -> electric_con_per_cold_months_mean;
many_electric_heaters -> electric_con_per_cold_months_mean;
electrichob_electric -> electric_con_per_cold_months_mean;
electrichob_electric -> electricoven_electric;
electrichob_electric -> gashob_gas;
electricoven_electric -> electric_con_per_cold_months_mean;
electricoven_electric -> gasoven_gas;
electricshower_electric -> electric_con_per_cold_months_mean;
electricshower_electric -> gas_pulse_per_cold_months_mean;
freezer_electric -> fridgefreezer_electric;
fridge_electric -> fridgefreezer_electric;
fridgefreezer_electric -> electric_con_per_cold_months_mean;
grill_electric -> electric_con_per_cold_months_mean;
kettle_electric -> electric_con_per_cold_months_mean;
microwave_electric -> electric_con_per_cold_months_mean;
other_electric -> electric_con_per_cold_months_mean;
toaster_electric -> electric_con_per_cold_months_mean;
tumbledrier_electric -> washingmachinetumbledrier_electric;
vacuumcleaner_electric -> electric_con_per_cold_months_mean;
washingmachine_electric -> washingmachinetumbledrier_electric;
washingmachinetumbledrier_electric -> electric_con_per_cold_months_mean;
woodburningstove_other_fuel -> electric_con_per_cold_months_mean;
woodburningstove_other_fuel -> gas_pulse_per_cold_months_mean;
air_conditioning -> electric_fan;
air_conditioning -> electric_con_per_cold_months_mean;
air_conditioning -> gas_pulse_per_cold_months_mean;
computer -> electric_con_per_cold_months_mean;
dehumidifier_electric -> electric_con_per_cold_months_mean;
dehumidifier_electric -> gas_pulse_per_cold_months_mean;
electric_blanket -> electric_con_per_cold_months_mean;
electric_blanket -> gas_pulse_per_cold_months_mean;
electric_fan -> electric_con_per_cold_months_mean;
electric_fan -> gas_pulse_per_cold_months_mean;
many_electric_heaters -> gas_pulse_per_cold_months_mean;
humidifier -> electric_con_per_cold_months_mean;
humidifier -> gas_pulse_per_cold_months_mean;
iron -> electric_con_per_cold_months_mean;
laptop -> electric_con_per_cold_months_mean;
media_entertainment -> electric_con_per_cold_months_mean;
motor_vehicle -> electric_con_per_cold_months_mean;
non_smartphone -> electric_con_per_cold_months_mean;
other_high_power_1 -> electric_con_per_cold_months_mean;
other_high_power_2 -> electric_con_per_cold_months_mean;
other_high_power_3 -> electric_con_per_cold_months_mean;
other_high_power_4 -> electric_con_per_cold_months_mean;
outdoor_electric_space_heater -> electric_con_per_cold_months_mean;
outdoor_hot_tub -> electric_con_per_cold_months_mean;
outdoor_light -> electric_con_per_cold_months_mean;
outdoor_water_feature -> electric_con_per_cold_months_mean;
smartphone -> media_entertainment;
smartphone -> non_smartphone;
smartphone -> electric_con_per_cold_months_mean;
sound_system -> electric_con_per_cold_months_mean;
tablet -> media_entertainment;
tablet -> electric_con_per_cold_months_mean;
television -> media_entertainment;
vacuum_cleaner -> electric_con_per_cold_months_mean;
unit_charge_pence_per_kwh_electricity -> electric_con_per_cold_months_mean;
unit_charge_pence_per_kwh_gas -> electric_con_per_cold_months_mean;
unit_charge_pence_per_kwh_electricity -> gas_pulse_per_cold_months_mean;
bath_gas -> gas_pulse_per_cold_months_mean;
bath_gas -> electric_con_per_cold_months_mean;
shower_gas -> electric_con_per_cold_months_mean;
shower_gas -> gas_pulse_per_cold_months_mean;
gasfire_gas -> gas_pulse_per_cold_months_mean;
gasfire_gas -> electric_con_per_cold_months_mean;
gashob_gas -> gas_pulse_per_cold_months_mean;
gashob_gas -> electric_con_per_cold_months_mean;
gasoven_gas -> gas_pulse_per_cold_months_mean;
gasoven_gas -> electric_con_per_cold_months_mean;
...
build_era -> sink_gas;
sink_gas -> gas_pulse_per_cold_months_mean;
U -> gas_pulse_per_cold_months_mean;
U -> electric_con_per_cold_months_mean;
...
externalwindows -> many_electric_heaters;
...
windowsopen -> many_electric_heaters;
...
externaldoors -> many_electric_heaters;
...
externalwalls -> many_electric_heaters;
...
cubic_area -> many_electric_heaters;
...
cubic_area_for_clothesdrying_percent -> many_electric_heaters;
...
cubic_area_with_trvs_percent -> many_electric_heaters;
...
radiators -> high_temperature;
cubic_area_with_trvs_percent -> high_temperature;
many_electric_heaters -> high_temperature;
woodburningstove_other_fuel -> high_temperature;
air_conditioning -> high_temperature;
electric_fan -> high_temperature;
gasfire_gas -> high_temperature; 
...
income_band -> urban_urban_rural_name_Large_Urban_Areas;
urban_urban_rural_name_Large_Urban_Areas -> outdoor_water_feature;
urban_urban_rural_name_Large_Urban_Areas -> outdoor_electric_space_heater;
urban_urban_rural_name_Large_Urban_Areas -> outdoor_hot_tub;
urban_urban_rural_name_Large_Urban_Areas -> outdoor_light;
urban_urban_rural_name_Large_Urban_Areas -> woodburningstove_other_fuel;
urban_urban_rural_name_Large_Urban_Areas -> cubic_area_with_trvs_percent;
urban_urban_rural_name_Large_Urban_Areas -> externalwalls;
urban_urban_rural_name_Large_Urban_Areas -> cubic_area_for_clothesdrying_percent;
urban_urban_rural_name_Large_Urban_Areas -> windowsopen;
urban_urban_rural_name_Large_Urban_Areas -> cubic_area;
urban_urban_rural_name_Large_Urban_Areas -> radiators;
urban_urban_rural_name_Large_Urban_Areas -> externalwindows;
urban_urban_rural_name_Large_Urban_Areas -> build_era;
urban_urban_rural_name_Large_Urban_Areas -> gasfire_gas;
...
model= CausalModel(
        ...
        treatment='many_electric_heaters',
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_15temp_cold_months.json', 'w') as fp:
