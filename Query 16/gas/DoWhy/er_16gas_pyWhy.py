...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_16gas.csv')
...
many_air_conditioning_fans -> electric_con_per_year_mean;
many_air_conditioning_fans -> high_gas_pulse_consumption;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_16gas_hot_months.json', 'w') as fp:
