...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_16gas.csv')

treatment = df['many_air_conditioning_fans']
y = df['high_gas_pulse_consumption']
df.drop('many_air_conditioning_fans', axis=1, inplace=True)
...
treat_col_name = 'many_air_conditioning_fans'
