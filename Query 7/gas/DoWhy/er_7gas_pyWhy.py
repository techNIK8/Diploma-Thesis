...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_7gas.csv')
...
high_cubic_area_per_room -> vacuum_cleaner;
...
externalwalls -> high_cubic_area_per_room;
...
high_cubic_area_per_room -> radiators;
high_cubic_area_per_room -> dehumidifier_electric;
high_cubic_area_per_room -> electricheater_electric;
high_cubic_area_per_room -> gasfire_gas;
high_cubic_area_per_room -> woodburningstove_other_fuel;
high_cubic_area_per_room -> air_conditioning;
high_cubic_area_per_room -> dehumidifier;
high_cubic_area_per_room -> electric_blanket;
high_cubic_area_per_room -> electric_fan;
high_cubic_area_per_room -> electric_heater;
high_cubic_area_per_room -> humidifier;
...
build_era -> high_cubic_area_per_room;
...
model= CausalModel(
        ...
        treatment='high_cubic_area_per_room',
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_7gas_hot_months.json', 'w') as fp:
