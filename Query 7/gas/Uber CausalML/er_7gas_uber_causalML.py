...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_7gas.csv')

treatment = df['high_cubic_area_per_room']
y = df['high_gas_pulse_consumption']
df.drop('high_cubic_area_per_room', axis=1, inplace=True)
...
treat_col_name = 'high_cubic_area_per_room'
