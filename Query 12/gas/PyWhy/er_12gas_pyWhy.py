...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_12gas.csv')
...
many_residents -> vacuum_cleaner;
many_residents -> outdoor_electric_space_heater;
many_residents -> other_high_power_3;
many_residents -> other_high_power_2;
many_residents -> other_high_power_4;
many_residents -> humidifier;
many_residents -> other_high_power_1;
many_residents -> occupied_days;
many_residents -> electric_fan;
many_residents -> electric_blanket;
many_residents -> occupied_nights;
many_residents -> iron;
many_residents -> dehumidifier;
many_residents -> weeklyhoursofwork;
many_residents -> sound_system;
many_residents -> dehumidifier_electric;
many_residents -> microwave_electric;
many_residents -> electricheater_electric;
many_residents -> air_conditioning;
many_residents -> kettle_electric;
many_residents -> laptop;
many_residents -> freezer_electric;
many_residents -> fridge_electric;
many_residents -> electrichob_electric;
many_residents -> computer;
many_residents -> washingmachine_electric;
many_residents -> vacuumcleaner_electric;
many_residents -> dishwasher_electric;
many_residents -> washingmachinetumbledrier_electric;
many_residents -> electricoven_electric;
many_residents -> tumbledrier_electric;
many_residents -> grill_electric;
many_residents -> toaster_electric;
many_residents -> other_electric;
many_residents -> media_entertainment;
many_residents -> fridgefreezer_electric;
many_residents -> smartphone;
many_residents -> tablet;
many_residents -> motor_vehicle;
many_residents -> unit_charge_pence_per_kwh;
many_residents -> non_smart_phone;
many_residents -> television;
many_residents -> gashob_gas;
many_residents -> gasoven_gas;
...
education_A to Levels or Highers;
education_Degree level qualification or equivalent eg BSc BA MSc MA;
education_GCSE grade D to G or CSE grade 2 to 5 or Standard Grade level 4 to 6;
education_Higher educational qualification below degree level;
education_No formal qualifications;
education_O Level or GCSE equivalent Grade A to C or O Grade_CSE equivalent Grade 1 or Standard Grade level 1;
education_Other qualifications;
education_PhD;
rural_name_Large Urban Areas;
rural_name_Other Urban Areas;
rural_name_Small Towns or Rural Areas;
...
with open(r'C:\Users\User\Desktop\Results doWhy\result_er_12gas_hot_months.json', 'w') as fp:
