...
df_2 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\er_12gas.csv')

treatment = df['many_residents']
y = df['high_gas_pulse_consumption']
df.drop('many_residents', axis=1, inplace=True)
