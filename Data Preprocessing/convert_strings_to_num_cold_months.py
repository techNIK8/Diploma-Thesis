...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\merged_cold_months.csv')
...
df.to_csv(r'C:\Users\User\Desktop\household_sensors\merged_numeric_cold_months.csv', index = None)