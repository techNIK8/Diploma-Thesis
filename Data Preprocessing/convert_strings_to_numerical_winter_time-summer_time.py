...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\merged_winter_time-summer_time.csv')
...
urban_rural_name = pd.get_dummies(df.urban_rural_name, prefix='rural_name')
...
df.to_csv(r'C:\Users\User\Desktop\household_sensors\merged_numeric_winter_time-summer_time.csv', index = None)
