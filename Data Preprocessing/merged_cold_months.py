...
data7 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\final_mean_electric-mains_electric-combined_cold_months.csv')
data8 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\final_mean_pulse_gas_cold_months.csv') 
data9 = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\final_mean_temperature_cold_months.csv') 
...
output = output[output.homeid.isin(values) == False]   #drop any rows that have values from the list = values in "homeid" column

output.to_csv(r'C:\Users\User\Desktop\household_sensors\merged_cold_months.csv', index=False)