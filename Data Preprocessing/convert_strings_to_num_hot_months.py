...
df = pd.read_csv(r'C:\Users\User\Desktop\household_sensors\merged_hot_months.csv')
...
df.to_csv(r'C:\Users\User\Desktop\household_sensors\merged_numeric_hot_months.csv', index = None)